...
st.title("Analysis of PhD graduates")
...
with col2:
    ...
    #Change colours
    colors = [palette_disc[24] if country == "Average" else palette_disc[15] for country in sorted_countries]
    #Create barchart
    ax, fig = new_plot("FLINTA*s in Higher Education")
...
st.caption("The data coming from other datasets was integrated to our original dataset.")